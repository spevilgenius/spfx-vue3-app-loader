...
interface VueAppControl {
  render: (container: Element, props: any) => {
    unmount: () => void;
...
export default class VueAppLoaderWebPart extends BaseClientSideWebPart<IVueAppLoaderWebPartProps> {
  ...
  public widgetlibraryurl: string = "https://cisgov.sharepoint.com/_api/web/lists/getbytitle('ScriptWebParts')/items?$select=*";
